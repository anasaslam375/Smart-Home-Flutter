...
import 'package:home/Widgets/Room/tv.dart';
import 'package:slidable_bar/slidable_bar.dart';
import 'package:velocity_x/velocity_x.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';


class TVLunch extends StatefulWidget {
  const TVLunch({ Key? key }) : super(key: key);

  @override
  _TVLunchState createState() => _TVLunchState();
}

class _TVLunchState extends State<TVLunch> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                width: size.width,
                child: isCheck
                    ? IgnorePointer(child: TVLunchWidget())
                    : TVLunchWidget(),
              )
            ],
          ),
